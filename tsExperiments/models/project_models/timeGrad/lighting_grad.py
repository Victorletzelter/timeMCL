# The lighting part of the timegrad we personnalized to be compatible with Lightning.
import lightning.pytorch as pl
import torch
from torch.optim.lr_scheduler import ReduceLROnPlateau

from tsExperiments.models.project_models.timeGrad.timeGradNetwork import (
...
class timeGrad(pl.LightningModule):
    ...
    def __init__(
        ...
        self.model = PersonnalizedTimeGrad(**model_kwargs)
    ...
    def training_step(self, batch, batch_idx: int):
        train_loss = self.model.loss(
            **select(self.inputs, batch),
            ...
            0
        ]  # because we return (loss.mean(), likelihoods, distr_args)
