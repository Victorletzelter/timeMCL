...
# This code was adapted from https://github.com/ServiceNow/TACTiS/blob/tactis-2/tactis/model/decoder.py
    ...
    def __init__(
        ...
        if activation_function == "relu":
            ...
            raise NotImplementedError(
                "Activation functions other than ReLU are not implemented"
            )
        ...
        for i in range(num_variables):
            ...
            if i == 0:
                ...
                for layer in range(self.attention_layers):
                    ...
                    values_samples_current_layer = values_samples[layer][
                        :, :, :, 0:i, :
                    ]
