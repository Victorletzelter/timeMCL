# This code was adapted from https://github.com/zalandoresearch/pytorch-ts/blob/master/pts/model/tempflow/tempflow_network.py
# under MIT License
...
class TempFlowNetwork(nn.Module):
    ...
    def unroll_encoder(
        ...
        scale_params
            Dictionary containing scaling parameters (scale, mean, std)
        lags_scaled
