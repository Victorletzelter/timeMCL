# the lighting part of the timegrad we personnalized (here).
# lighthing transtempflow
import lightning.pytorch as pl
import torch
from torch.optim.lr_scheduler import ReduceLROnPlateau

from tsExperiments.models.project_models.transformerTempFlow.transTempFlow_network import (
...
class TransTempFlowLighting(pl.LightningModule):
    ...
    def __init__(
        ...
        self.model = TransformerTempFlowNetkork(**model_kwargs)
